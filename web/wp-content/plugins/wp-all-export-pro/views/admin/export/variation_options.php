            ...
            <label>
                <input type="radio" class="export_variations <?php if (PMXE_EDITION != 'paid') {
                    ...
                    <?php if(XmlExportEngine::get_addons_service()->isWooCommerceProductAddonActive()) { echo "disabled"; }?>
                       value="<?php echo XmlExportEngine::VARIABLE_PRODUCTS_EXPORT_PARENT_AND_VARIATION; ?>" <?php if ($post['export_variations'] == XmlExportEngine::VARIABLE_PRODUCTS_EXPORT_PARENT_AND_VARIATION && PMXE_EDITION == 'paid' && XmlExportEngine::get_addons_service()->isWooCommerceAddonActive()) { ?> checked="checked"  <?php } ?>
