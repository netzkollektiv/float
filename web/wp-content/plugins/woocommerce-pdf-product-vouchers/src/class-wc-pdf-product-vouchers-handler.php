	...
	public function get_voucher_statuses() {
		...
		$statuses = array(
			...
			'wcpdf-redeemed' => array(
				'label'       => _x( 'Redeemed', 'Voucher Status', 'woocommerce-pdf-product-vouchers' ),
			...
			'wcpdf-expired'  => array(
				'label'       => _x( 'Expired', 'Voucher Status', 'woocommerce-pdf-product-vouchers' ),
			...
			'wcpdf-voided'  => array(
				'label'       => _x( 'Voided', 'Voucher Status', 'woocommerce-pdf-product-vouchers' ),
				/* translators: Expired Voucher(s) */
