 ...
 * @since 3.0.0
 *
 * @method \WC_PDF_Product_Vouchers get_plugin()
 */
class WC_PDF_Product_Vouchers_Upgrade extends Framework\Plugin\Lifecycle {


	/**
	 * WC_PDF_Product_Vouchers_Upgrade constructor.
	 *
	 * @since 3.5.5
	 *
	 * @param \WC_PDF_Product_Vouchers $plugin
	 */
