 ...
 * @since 3.5.0
 */
class WC_PDF_Product_Vouchers_Redeem_Single implements WC_PDF_Product_Vouchers_Redeem {
	...
	public function redeem( $voucher, $amount ) {
		...
		$message_text = esc_html__( 'Voucher %s x 1 was redeemed.', 'woocommerce-pdf-product-vouchers' );
		if ( $remaining > 0 ) {
		...
		$response = new WC_PDF_Product_Vouchers_Redeem_Response_Single();
