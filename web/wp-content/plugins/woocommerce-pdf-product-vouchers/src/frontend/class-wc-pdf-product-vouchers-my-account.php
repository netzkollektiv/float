...
class My_Account {
	...
	public function __construct() {
		...
		add_action( "woocommerce_account_{$this->vouchers_endpoint}_endpoint", 'wc_pdf_product_vouchers_account_vouchers' );
	...
	public function add_menu_items( $items ) {
		...
		if ( ! isset( $items[ $this->vouchers_query_var ] ) && $this->get_vouchers_endpoint() ) {
			...
			$items[ $this->vouchers_query_var ] = __( 'Vouchers', 'woocommerce-pdf-product-vouchers' );
