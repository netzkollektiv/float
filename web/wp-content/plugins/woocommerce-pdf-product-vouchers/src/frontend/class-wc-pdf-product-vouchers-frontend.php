...
class WC_PDF_Product_Vouchers_Frontend {
	...
	/** @var \SkyVerge\WooCommerce\PDF_Product_Vouchers\Frontend\My_Account instance */
	private $my_account;
	...
	public function __construct() {
		...
		$this->my_account = wc_pdf_product_vouchers()->load_class( '/src/frontend/class-wc-pdf-product-vouchers-my-account.php', '\\SkyVerge\\WooCommerce\\PDF_Product_Vouchers\\Frontend\\My_Account' );
	 ...
	 * @since 3.5.4
	 *
	 * @return \SkyVerge\WooCommerce\PDF_Product_Vouchers\Frontend\My_Account
	 */
