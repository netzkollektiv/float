 ...
 * Documentation URI: https://docs.woocommerce.com/document/woocommerce-pdf-product-vouchers/
 ...
 * @since 3.5.0
 */
class WC_PDF_Product_Vouchers_Loader {
	...
	const PLUGIN_NAME = 'WooCommerce PDF Product Vouchers';


	/** @var \WC_PDF_Product_Vouchers_Loader single instance of this class */
	...
	/**
	 * Displays any admin notices added with \WC_PDF_Product_Vouchers_Loader::add_admin_notice()
	 *
	 * @internal
	 *
	 * @since 3.5.0
	 ...
	 * @since 3.5.0
	 *
	 * @return \WC_PDF_Product_Vouchers_Loader
	 */
...
// fire it up!
WC_PDF_Product_Vouchers_Loader::instance();
