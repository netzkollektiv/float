 ...
 */
registerBlockType( 'fuel-themes/thb-woocommerce-category-block-grid', {
	// Block name. Block names must be string that contains a namespace prefix. Example: my-plugin/my-custom-block.
	title: __( 'WooCommerce Category Block Grid', 'pure-fashion' ), // Block title.
	...
	keywords: [
		__( 'woocommerce', 'pure-fashion' ),
		__( 'category', 'pure-fashion' ),
		__( 'fuel', 'pure-fashion' ),
	],
	supports: {
		html: false,
		align: [ 'wide', 'full' ],
